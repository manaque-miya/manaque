...

  {
    ...
    subjects: [
      ...
      },
      {
        ...
        badge: { text: '国語', cls: 'badge--orange' },
        units: [
          { label: '古文単語クイズ 250問 完全制覇', quizId: 'exam-kobun', count: 250, time: '全10ユニット', difficulty: 4, gacha: false, isNew: true, tags: [{ text: '国語', cls: 'badge--orange' }, { text: '高校生', cls: 'badge--neutral' }] }
        ]
      },
      {
        id: 'math-high',
    ...
    subjects: [
      {
        ...
        emoji: '📖',
        units: [
          { label: 'SPI言語：二語の関係・類義語・対義語', quizId: 'uni-spi-lang-01', count: 20, time: '約15分', difficulty: 3, gacha: false, isNew: true,
            tags: [{ text: 'SPI', cls: 'badge--sky' }, { text: '大学生', cls: 'badge--neutral' }] },
          { label: 'SPI言語：語句の意味・用法',           quizId: 'uni-spi-lang-02', count: 20, time: '約15分', difficulty: 3, gacha: false, isNew: true,
            tags: [{ text: 'SPI', cls: 'badge--sky' }, { text: '大学生', cls: 'badge--neutral' }] },
          { label: 'SPI言語：文章完成・接続詞補充',       quizId: 'uni-spi-lang-03', count: 20, time: '約15分', difficulty: 3, gacha: false, isNew: true,
            tags: [{ text: 'SPI', cls: 'badge--sky' }, { text: '大学生', cls: 'badge--neutral' }] },
          { label: 'SPI言語：長文読解・文章理解',         quizId: 'uni-spi-lang-04', count: 20, time: '約15分', difficulty: 4, gacha: false, isNew: true,
            tags: [{ text: 'SPI', cls: 'badge--sky' }, { text: '大学生', cls: 'badge--neutral' }] },
      ...
      },
      {
        ...
        emoji: '🔢',
        units: [
          { label: 'SPI非言語：割合・比・濃度',       quizId: 'uni-spi-math-01', count: 20, time: '約15分', difficulty: 3, gacha: false, isNew: true,
            tags: [{ text: 'SPI', cls: 'badge--sky' }, { text: '大学生', cls: 'badge--neutral' }] },
          { label: 'SPI非言語：速さ・時間・距離',     quizId: 'uni-spi-math-02', count: 20, time: '約15分', difficulty: 3, gacha: false, isNew: true,
            tags: [{ text: 'SPI', cls: 'badge--sky' }, { text: '大学生', cls: 'badge--neutral' }] },
          { label: 'SPI非言語：場合の数・確率',       quizId: 'uni-spi-math-03', count: 20, time: '約15分', difficulty: 4, gacha: false, isNew: true,
            tags: [{ text: 'SPI', cls: 'badge--sky' }, { text: '大学生', cls: 'badge--neutral' }] },
          { label: 'SPI非言語：推論・集合・論理',     quizId: 'uni-spi-math-04', count: 20, time: '約15分', difficulty: 4, gacha: false, isNew: true,
            tags: [{ text: 'SPI', cls: 'badge--sky' }, { text: '大学生', cls: 'badge--neutral' }] },
    ...
    subjects: [
      {
        ...
        units: [
          { label: '漢字検定2級レベル', quizId: 'adult-exam-01', count: 30, time: '約15分', difficulty: 3, gacha: false, isNew: true,
            desc: '高校卒業レベルの漢字力を測る文部科学省後援の検定。読み・書き・四字熟語を幅広く出題。',
          ...
          { label: 'FP3級 実技類題', quizId: 'fp3-jitsugi-01', count: 20, time: '約10分', difficulty: 3, gacha: false, isNew: true,
            ...
            tags: [{ text: 'FP3級', cls: 'badge--green' }, { text: '資格', cls: 'badge--purple' }, { text: '大人向け', cls: 'badge--neutral' }] },
          { label: 'FP3級 ライフプランニング', quizId: 'fp3-life-01', count: 84, time: '約15分', difficulty: 3, gacha: false, isNew: true,
            desc: '年金・社会保険・住宅ローン・係数計算など、FP3級ライフプランニング分野の類題84問。',
            tags: [{ text: 'FP3級', cls: 'badge--green' }, { text: '資格', cls: 'badge--purple' }, { text: '大人向け', cls: 'badge--neutral' }] },
          { label: 'FP3級 リスク管理', quizId: 'fp3-risk-01', count: 81, time: '約15分', difficulty: 3, gacha: false, isNew: true,
            desc: '生命保険・損害保険・第三分野保険など、FP3級リスク管理分野の類題81問。',
            tags: [{ text: 'FP3級', cls: 'badge--green' }, { text: '資格', cls: 'badge--purple' }, { text: '大人向け', cls: 'badge--neutral' }] },
          { label: 'FP3級 金融資産運用', quizId: 'fp3-finance-01', count: 77, time: '約15分', difficulty: 3, gacha: false, isNew: true,
            desc: '株式・債券・投資信託・NISA・外貨など、FP3級金融資産運用分野の類題77問。',
            tags: [{ text: 'FP3級', cls: 'badge--green' }, { text: '資格', cls: 'badge--purple' }, { text: '大人向け', cls: 'badge--neutral' }] },
          { label: 'FP3級 タックスプランニング', quizId: 'fp3-tax-01', count: 69, time: '約15分', difficulty: 3, gacha: false, isNew: true,
            desc: '所得税・給与所得控除・確定申告など、FP3級タックスプランニング分野の類題69問。',
            tags: [{ text: 'FP3級', cls: 'badge--green' }, { text: '資格', cls: 'badge--purple' }, { text: '大人向け', cls: 'badge--neutral' }] },
          { label: 'FP3級 不動産', quizId: 'fp3-fudosan-01', count: 63, time: '約15分', difficulty: 3, gacha: false, isNew: true,
            desc: '不動産登記・借地借家法・住宅ローン控除など、FP3級不動産分野の類題63問。',
            tags: [{ text: 'FP3級', cls: 'badge--green' }, { text: '資格', cls: 'badge--purple' }, { text: '大人向け', cls: 'badge--neutral' }] },
          { label: 'FP3級 相続・事業承継', quizId: 'fp3-sozoku-01', count: 68, time: '約15分', difficulty: 3, gacha: false, isNew: true,
            desc: '相続税・遺言・贈与税・法定相続分など、FP3級相続・事業承継分野の類題68問。',
            tags: [{ text: 'FP3級', cls: 'badge--green' }, { text: '資格', cls: 'badge--purple' }, { text: '大人向け', cls: 'badge--neutral' }] },
          { label: 'FP3級 用語カード', quizId: 'fp3-vocab', count: 650, time: '約30分', difficulty: 2, gacha: false, isNew: true,
            desc: 'FP3級頻出650用語を2択カードで直感学習。シナリオ形式で出題し、正解後にexp1〜exp3の3層解説＋覚え方フレーズ。年収の壁・iDeCo・NISA・相続改正対応。FP3 過去問・勉強方法・独学・何時間にも。',
            tags: [{ text: 'FP3級', cls: 'badge--green' }, { text: '用語', cls: 'badge--sky' }, { text: '大人向け', cls: 'badge--neutral' }] },
          { label: '宅建士 用語カード', quizId: 'takken-vocab', count: 700, time: '約35分', difficulty: 3, gacha: false, isNew: true,
            desc: '宅建士頻出700用語を2択カードで直感学習。権利関係・業法・法令・税の全分野SVG図解付き。山田さん・佐藤さんのドラマで自分ごと体験。宅建 過去問・勉強方法・独学・合格率にも。',
            tags: [{ text: '宅建士', cls: 'badge--orange' }, { text: '用語', cls: 'badge--sky' }, { text: '大人向け', cls: 'badge--neutral' }] },
          ...
          { label: '漢検 用語カード', quizId: 'kanken-vocab', count: 400, time: '約20分', difficulty: 2, gacha: false, isNew: true,
            desc: '漢検頻出400語を2択カードで直感学習。読み・書き・意味・部首・熟語を3層解説。覚え方フレーズで定着率UP。漢検 過去問・勉強方法・独学・何時間・合格率にも。受験者200万人の人気検定。',
            tags: [{ text: '漢検', cls: 'badge--red' }, { text: '用語', cls: 'badge--sky' }, { text: '大人向け', cls: 'badge--neutral' }] },
          { label: '危険物乙4 用語カード', quizId: 'kikenbutsu-vocab', count: 250, time: '約15分', difficulty: 3, gacha: false, isNew: true,
            desc: '危険物取扱者乙4頻出250語を2択カードで直感学習。物質の性質・燃焼・消火・法令を網羅。覚え方フレーズで定着率UP。危険物乙4 過去問・勉強方法・独学・何時間・合格率にも。受験者25万人の国家資格。',
            tags: [{ text: '危険物乙4', cls: 'badge--orange' }, { text: '用語', cls: 'badge--sky' }, { text: '大人向け', cls: 'badge--neutral' }] },
          { label: '衛生管理者 用語カード', quizId: 'eisei-vocab', count: 450, time: '約25分', difficulty: 3, gacha: false, isNew: true,
            desc: '衛生管理者頻出450語を2択カードで直感学習。労働衛生・労働生理・関係法令を網羅。覚え方フレーズで定着率UP。衛生管理者 過去問・勉強方法・独学・何時間・合格率にも。受験者6万人の必置資格。',
            tags: [{ text: '衛生管理者', cls: 'badge--green' }, { text: '用語', cls: 'badge--sky' }, { text: '大人向け', cls: 'badge--neutral' }] },
          { label: '数学検定 用語カード', quizId: 'math-vocab', count: 600, time: '約30分', difficulty: 3, gacha: false, isNew: true,
            desc: '数学検定頻出600語を2択カードで直感学習。数と式・図形・関数・確率・微積を網羅。覚え方フレーズで定着率UP。数学検定 過去問・勉強方法・独学・何時間・合格率にも。受験者30万人の人気検定。',
            tags: [{ text: '数学検定', cls: 'badge--purple' }, { text: '用語', cls: 'badge--sky' }, { text: '大人向け', cls: 'badge--neutral' }] },
...
,
  {
    id: 'shikaku', label: '資格・検定', ruby: 'しかく', emoji: '📋',
    colorClass: 'cat--shikaku',
    subjects: [
      {
        id: 'exam-itp', label: 'ITパスポート', emoji: '💻',
        units: [
          {
            label: 'ITパスポート 本気対策',
            quizId: 'exam-itp',
