    ...
    subjects: [
      {
        ...
        units: [
          ...
          { label: 'FP3級 相続・事業承継', quizId: 'fp3-sozoku-01', count: 30, time: '約15分', difficulty: 3, gacha: false, isNew: true,
            ...
            tags: [{ text: 'FP3級', cls: 'badge--green' }, { text: '資格', cls: 'badge--purple' }, { text: '大人向け', cls: 'badge--neutral' }] },
          { label: 'FP3級 用語カード', quizId: 'fp3-vocab', count: 500, time: '約25分', difficulty: 2, gacha: false, isNew: true,
            desc: 'FP3級頻出500用語を2択カードで直感学習。シナリオ形式で出題し、正解後にexp1〜exp3の3層解説。',
            tags: [{ text: 'FP3級', cls: 'badge--green' }, { text: '用語', cls: 'badge--sky' }, { text: '大人向け', cls: 'badge--neutral' }] },
          { label: '宅建士 用語カード', quizId: 'takken-vocab', count: 500, time: '約25分', difficulty: 3, gacha: false, isNew: true,
            desc: '宅建士頻出500用語を2択カードで直感学習。権利関係・業法・法令・税の全分野SVG図解付き。シナリオ形式で出題し、正解後にexp1〜exp3の3層解説。',
